        ...
        const displayDriverList = (data) => {
            ...
            sortedRoutes.forEach((route, index) => {
                ...
                groupedByRoute[route].forEach(item => {
                    ...
                    const notPickedButton = listItem.querySelector('.not-picked');
                    const notDroppedButton = listItem.querySelector('.not-dropped');
                    const callButton = listItem.querySelector('.call-button');
        
                    if (notPickedButton) {
                        // Event listener for "Not Picked" button
                        notPickedButton.addEventListener('click', async () => {
                    ...
                    if (notDroppedButton) {
                        ...
                        notDroppedButton.addEventListener('click', async () => {
