    ...
    const tableQueries = [
        ...
        },
        {
            query: `CREATE TABLE IF NOT EXISTS pre_primary_student_details (
                ...
                Sections VARCHAR(1) DEFAULT NULL,
                ...
                Mothername VARCHAR(14) DEFAULT NULL,
                Grno INT(4) DEFAULT NULL,
                Division VARCHAR(6) DEFAULT NULL,
                Standard VARCHAR(7) DEFAULT NULL,
                Roll_No INT(1) DEFAULT NULL,
                DOB VARCHAR(10) DEFAULT NULL,
                Age INT(1) DEFAULT NULL,
                POB VARCHAR(19) DEFAULT NULL,
                Mother_Tongue VARCHAR(7) DEFAULT NULL,
                Caste VARCHAR(4) DEFAULT NULL,
                Sub_caste VARCHAR(11) DEFAULT NULL,
                ...
                Riligion VARCHAR(51) DEFAULT NULL,
                ...
                Mobile_no VARCHAR(1) DEFAULT NULL,
                Father_name VARCHAR(11) DEFAULT NULL,
                F_qualification VARCHAR(2) DEFAULT NULL,
                f_off_address VARCHAR(1) DEFAULT NULL,
                f_occupation VARCHAR(1) DEFAULT NULL,
                f_per_address VARCHAR(1) DEFAULT NULL,
                f_mobile_no BIGINT(10) DEFAULT NULL,
                f_office_tel INT(1) DEFAULT NULL,
                Mother_name VARCHAR(14) DEFAULT NULL,
                M_Qualification VARCHAR(3) DEFAULT NULL,
                M_off_address VARCHAR(1) DEFAULT NULL,
                M_occupation VARCHAR(1) DEFAULT NULL,
        ...
        },
        {
            query: `CREATE TABLE IF NOT EXISTS primary_student_details (
                ...
                Sections VARCHAR(15) DEFAULT NULL,
                Gender VARCHAR(6) DEFAULT NULL,
                ...
                Riligion VARCHAR(12) DEFAULT NULL,
                Nationality VARCHAR(6) DEFAULT NULL,
                Domicile VARCHAR(11) DEFAULT NULL,
                Buss VARCHAR(30) DEFAULT NULL,
                Father_name VARCHAR(15) DEFAULT NULL,
                F_qualification VARCHAR(7) DEFAULT NULL,
                f_off_address VARCHAR(6) DEFAULT NULL,
                f_occupation VARCHAR(15) DEFAULT NULL,
                f_per_address VARCHAR(15) DEFAULT NULL,
                f_mobile_no VARCHAR(10) DEFAULT NULL,
                f_office_tel VARCHAR(10) DEFAULT NULL,
                Mother_name VARCHAR(15) DEFAULT NULL,
                M_Qualification VARCHAR(6) DEFAULT NULL,
                M_off_address VARCHAR(6) DEFAULT NULL,
                M_occupation VARCHAR(10) DEFAULT NULL,
                M_per_address VARCHAR(15) DEFAULT NULL,
                M_mobile_no VARCHAR(11) DEFAULT NULL,
                ...
                Grand_father VARCHAR(15) DEFAULT NULL,
