...
// PUT Endpoint to edit a fee category
router.put('/editFeeCategory/:categoryId', (req, res) => {
    ...
    req.connectionPool.query(updateQuery, [category_name, description, categoryId], (error, results) => {
        if (error) {
            console.error('Error updating fee_categories:', error);
